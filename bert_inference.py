...
def preprocess_sof_data(data_csv_path="./data/stack_overflow_questions/train-sample.csv"):
    ...
    train_dataset = train_dataset.map(lambda example: standard_scale(example, mean_train, std_train))
    val_dataset = val_dataset.map(lambda example: standard_scale(example, mean_train, std_train))
    test_dataset = test_dataset.map(lambda example: standard_scale(example, mean_train, std_train))
...
if __name__ == '__main__':
    path_to_data = "./data/closed_stack_overflow/train-sample.csv"
