...
class Transformer(nn.Module):
    ...
    def __init__(
            self, n_src_vocab, n_trg_vocab, src_pad_idx=None, trg_pad_idx=None,
    ...
    def forward(self, src_seq):
        ...
        # return seq_logit.view(-1, seq_logit.size(2)), seq_logit.shape
        seq_logit = seq_logit.permute(0, 2, 1)  # change dimension to (B, C, T)
        return seq_logit, seq_logit.shape
